...
func NewServer(app *AppImpl) *echo.Echo {
	...
	e.GET("/admin/api/cache/stats", app.HandleAdminApiCacheStats, app.RequireAuth)
	e.GET("/admin/api/cache/list", app.HandleAdminApiCacheList, app.RequireAuth)
	e.POST("/admin/api/cache/purge", app.HandleAdminApiCachePurge, app.RequireAuth)
